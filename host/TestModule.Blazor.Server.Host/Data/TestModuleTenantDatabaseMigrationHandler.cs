...
using TestModule.Blazor.Server.Host.EntityFrameworkCore;
...
public class TestModuleTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<TestModuleTenantDatabaseMigrationHandler> _logger;

    public TestModuleTenantDatabaseMigrationHandler(
        IDbContextProvider<UnifiedDbContext> dbContextProvider,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<TestModuleTenantDatabaseMigrationHandler> logger)
    {
